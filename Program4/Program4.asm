...
LD R3 ARRSTART
LD R2 NEWLINE
CALLNEXT TRAP x23	;PROMPTS USER FOR INPUT
ADD R0,R0,#-16	;REDUCES R0 BY 16
ADD R0,R0,#-16	;3 TIMES TO GET
ADD R0,R0,#-16	;THE INTENDED VALUE OF THE INPUT
STR R0,R3,#0	;STORES THE INPUT INTO THE LOCATION POINTED AT BY R3
ADD R3,R3,#1	;INCREMENTS R3
STI R2,DDR
ADD R0,R0,#0	;CHECKS THE SIGNAGE OF R0
BRP CALLNEXT	;REPEATS THIS UNTIL THE USER INPUTS A 0
ADD R3,R3,#-2	;DECREMENTS R3
ST R3,ARREND	;SETS THE SIZE OF THE ARRAY
