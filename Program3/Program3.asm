...
LDR R5,R7,#0	;SETS R5 TO THE FIRST ADDRESS
...
SWITCH	STR R2,R7,#0	;STORES THE VALUE STORED IN R2 INTO THE LOCATION POINTED AT BY R5
;LDR R5,R7,#0
STR R5,R6,#0	;STORES THE VALUE STORED IN R7 INTO THE LOCATION POINTED AT BY R6
BRNZP FINISH	;ENDS THE PROGRAM HERE, FOR TESTING PURPOSES
